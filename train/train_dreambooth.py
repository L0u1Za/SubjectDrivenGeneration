...
def log_validation(
    ...
    if args.validation_images is None:
        for i in range(args.num_validation_images):
            for args in pipeline_args:
                with torch.autocast("cuda"):
                    image = pipeline(**args, num_inference_steps=25, generator=generator).images[0]
                images.append({
                    "image": image,
                    "prompt": args["prompt"],
                    "iteration": i
        ...
        for i, image in enumerate(args.validation_images):
            ...
            for args in pipeline_args:
                image = pipeline(**args, image=image, generator=generator).images[0]
                images.append({
                    "image": image,
                    "prompt": args["prompt"],
                    "iteration": i
    ...
    return [it["image"] for it in images]
